...
| | |
| --- | --- |
| Contributors | [halgatewood](https://profiles.wordpress.org/halgatewood), [ghuger](https://profiles.wordpress.org/ghuger), [richardgabriel](https://profiles.wordpress.org/richardgabriel) |
| Donate | [https://halgatewood.com/donate/](https://halgatewood.com/donate/) |
...
- [Getting Started](https://www.youtube.com/watch?v=SVg73QdgSuM)
- [Overview](https://www.youtube.com/watch?v=IMWVDHbtnVw)

## Installation

1. Add plugin to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Add a testimonial rotator
4. Create testimonials and specify which rotator you want it to be a part of
5. Add the rotators to your pages using the shortcode or developers can add the placeholders in their themes.
